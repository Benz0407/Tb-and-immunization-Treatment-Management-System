...
class TbAppointmentsListWidget extends StatelessWidget {
  final List<TbAppointment> appointments;

  const TbAppointmentsListWidget({super.key, required this.appointments});
        ...
        children: [
          ...
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              TbAppointment appointment = appointments[index];
